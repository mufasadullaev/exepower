...
function getCellValue($parameterId, $equipmentId) {
    $mapping = [
        ...
        // === ПАРАМЕТРЫ БЛОКОВ (equipment_type_id = 1) ===
        // P острого пара перед т/а (parameter_id: 29)
        29 => [
            1 => 'С14',   // ТГ7
            2 => 'D14',   // ТГ8
            7 => 'E14' // ОЧ-130
        ],
        // t острого пара перед т/а (parameter_id: 30)
        30 => [
            1 => 'C15',   // ТГ7
            2 => 'D15',   // ТГ8
            7 => 'E15' // ОЧ-130
        ],
        // t в циркводы на входе (parameter_id: 31)
        31 => [
            1 => 'C16',   // ТГ7
            2 => 'D16',   // ТГ8
            7 => 'E16' // ОЧ-130
        ],
        // t в циркводы на выходе (parameter_id: 32)
        32 => [
            1 => 'C17',   // ТГ7
            2 => 'D17',   // ТГ8
            7 => 'E17' // ОЧ-130
        ],
        // t питательной воды (parameter_id: 33)
        33 => [
            1 => 'C18',   // ТГ7
            2 => 'D18',   // ТГ8
            7 => 'E18' // ОЧ-130
        ],
        // Расход дистиллята (parameter_id: 34)
        34 => [
            1 => 'C19',   // ТГ7
            2 => 'D19',   // ТГ8
            7 => 'E19' // ОЧ-130
        ],
        // Выработка пара котлами (parameter_id: 35)
        35 => [
            1 => 'C20',   // ТГ7
            2 => 'D20',   // ТГ8
            7 => 'E20' // ОЧ-130
        ],
        // Продувка (parameter_id: 36)
        36 => [
            1 => 'C21',   // ТГ7
            2 => 'D21',   // ТГ8
            7 => 'E21' // ОЧ-130
        ],
        // Расход питательной воды (parameter_id: 37)
        37 => [
            1 => 'C22',   // ТГ7
            2 => 'D22',   // ТГ8
            7 => 'E22' // ОЧ-130
        ],
        // t пара после промперегрева (parameter_id: 38)
        38 => [
            1 => 'C23',   // ТГ7
            2 => 'D23',   // ТГ8
            7 => 'E23' // ОЧ-130
        ],
        // t пара до промперегрева (parameter_id: 39)
        39 => [
            1 => 'C24',   // ТГ7
            2 => 'D24',   // ТГ8
            7 => 'E24' // ОЧ-130
        ],
        // t питательной воды ПВД (parameter_id: 40)
        40 => [
            1 => 'C25',   // ТГ7
            2 => 'D25',   // ТГ8
            7 => 'E25' // ОЧ-130
        ],
        // P кс питательной воды (parameter_id: 41)
        41 => [
            1 => 'C26',   // ТГ7
            2 => 'D26',   // ТГ8
            7 => 'E26' // ОЧ-130
        ],
        // t холодного воздуха (parameter_id: 42)
        42 => [
            1 => 'C27',   // ТГ7
            2 => 'D27',   // ТГ8
            7 => 'E27' // ОЧ-130
        ],
        // Факт Qнр (газ) (parameter_id: 43)
        43 => [
            1 => 'C28',   // ТГ7
            2 => 'D28',   // ТГ8
            7 => 'E28' // ОЧ-130
        ],
        // Факт Qнр (мазут) (parameter_id: 44)
        44 => [
            1 => 'C29',   // ТГ7
            2 => 'D29',   // ТГ8
            7 => 'E29' // ОЧ-130
        ],
        // В топлива за месяц (газ) (parameter_id: 45)
        45 => [
            1 => 'C30',   // ТГ7
            2 => 'D30',   // ТГ8
            7 => 'E30' // ОЧ-130
        ],
        // В топлива за месяц (мазут) (parameter_id: 46)
        46 => [
            1 => 'C31',   // ТГ7
            2 => 'D31',   // ТГ8
            7 => 'E31' // ОЧ-130
        ],
        // Температура уходящих газов (parameter_id: 47)
        47 => [
            1 => 'C32',   // ТГ7
            2 => 'D32',   // ТГ8
            7 => 'E32' // ОЧ-130
        ],
        // α- уходящих (parameter_id: 48)
        48 => [
            1 => 'C33',   // ТГ7
            2 => 'D33',   // ТГ8
            7 => 'E33' // ОЧ-130
        ],
        // Продолжительность работы тг от даты разр. (parameter_id: 49)
        49 => [
            1 => 'C12',   // ТГ7
            2 => 'D12'    // ТГ8
            // ОЧ-130 не включаем
        ...
        // === НОВЫЕ ПАРАМЕТРЫ БЛОКОВ (50-57) ===
        // Qкбр - Теплопроизводительность котла брутто (parameter_id: 50)
        50 => [
            1 => 'C38',   // ТГ7
            2 => 'D38'    // ТГ8
            // ОЧ-130 не включаем
        ],
        // Dпара - Расход пара промперегрева (parameter_id: 51)
        51 => [
            1 => 'C39',   // ТГ7
            2 => 'D39'    // ТГ8
            // ОЧ-130 не включаем
        ],
        // Pабс пара п.п. после к/а - Абсолютное давление пара п.п. после к/а (parameter_id: 52)
        52 => [
            1 => 'C40',   // ТГ7
            2 => 'D40'    // ТГ8
            // ОЧ-130 не включаем
        ],
        // Pабс пара п.п. до к/а - Абсолютное давление пара п.п. до к/а (parameter_id: 53)
        53 => [
            1 => 'C41',   // ТГ7
            2 => 'D41'    // ТГ8
            // ОЧ-130 не включаем
        ],
        // i острого пара - Энтальпия острого пара (parameter_id: 54)
        54 => [
            1 => 'C42',   // ТГ7
            2 => 'D42'    // ТГ8
            // ОЧ-130 не включаем
        ],
        // i горячего п.п. - Энтальпия горячего пара промперегрева (parameter_id: 55)
        55 => [
            1 => 'C43',   // ТГ7
            2 => 'D43'    // ТГ8
            // ОЧ-130 не включаем
        ],
        // i холодного п.п. - Энтальпия холодного пара промперегрева (parameter_id: 56)
        56 => [
            1 => 'C44',   // ТГ7
            2 => 'D44'    // ТГ8
            // ОЧ-130 не включаем
        ],
        // i питательной воды - Энтальпия питательной воды (parameter_id: 57)
        57 => [
            1 => 'C45',   // ТГ7
            2 => 'D45'    // ТГ8
            // ОЧ-130 не включаем
